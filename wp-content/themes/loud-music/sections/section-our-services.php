 ...
 */
    ...
    $services_content_type         = loud_music_get_option( 'services_content_type' );
    $number_of_items               = loud_music_get_option( 'number_of_items' );

    if( $services_content_type == 'services_page' ) :
        for( $i=1; $i<=$number_of_items; $i++ ) :
            $our_services_pages[] = loud_music_get_option( 'our_services_page_'.$i );
        endfor;  
    elseif( $services_content_type == 'services_post' ) :
        for( $i=1; $i<=$number_of_items; $i++ ) :
            $our_services_posts[] = loud_music_get_option( 'our_services_post_'.$i );
        endfor;
    endif;
    ?>
        ...
        <div class="section-content clear col-3">
            ...
            $loop = new WP_Query($args);                        
                ...
                $i=-1; $j=0;  
                    ...
                    $our_services_icons[$j] = loud_music_get_option( 'our_services_icon_'.$j ); ?>             
