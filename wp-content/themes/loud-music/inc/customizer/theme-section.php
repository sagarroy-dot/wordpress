...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'loud-music' ),
	'priority'   => 100,
...
'title'       => __('Layout Option', 'loud-music'),
...
$wp_customize->add_control(new loud_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'loud-music'),
...
$wp_customize->add_control(new loud_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'loud-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new loud_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'loud-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new loud_music_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'loud-music'),
	'section' 	=> 'section_general',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'loud-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => __( 'Excerpt Length', 'loud-music' ),
	'description' => __( 'in words', 'loud-music' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'loud-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'loud-music' ),
...
$wp_customize->add_section('section_blog_title', 
	array(    
	'title'       => __('Blog Title', 'loud-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'loud-music' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'loud-music'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'loud-music' ),
...
$wp_customize->add_control( 'theme_options[enable_frontpage_content]', array(
	'label'       	=> __( 'Enable Content', 'loud-music' ),
	'description' 	=> __( 'Click to enable content on static front page only.', 'loud-music' ),
